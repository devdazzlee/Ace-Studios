                        ...
                        <div className="col-lg-4 col-md-6 col-sm-6">
                            ...
                            <div className="footer-widget footer-about-widget mb-40 pf_fadeup">
                                <div className="footer-content">
                                    <div className="">
                                        <a href="index.html"><img style={{ width: '200px', height: '100px' }} src="/assets/images/creative-agency/logo/Logo.svg" alt="Brand Logo" /></a>
                                    </div>
                                    <p>Ace Studios creative digital agency delivering innovate web Development marketing.</p>
                                    <form>
                                        ...
                                        <div className="footer-content">
                                            ...
                                            <div className="agenko-iconic-box style-three mb-30">
                                                ...
                                                <div className="content">
                                                    <h6>Email</h6>
                                                    <p><a href="mailto:info@acestudios.com">info@acestudios.com</a></p>
                                                </div>
                                            </div>
                                            <div className="agenko-iconic-box style-three">
                                                ...
                                                <div className="content">
                                                    <h6>Phone</h6>
                                                    <p><a href="tel:+92 336 2500357">+92 336 2500357</a></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            ...
                            <div className="copyright-text">
                                <p>&copy; 2025 <span>Ace Studios</span> - All Rights Reserved.</p>
                            </div>
                        </div>
                        <div className="col-md-6">
